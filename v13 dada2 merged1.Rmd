...
mergers <- mergePairs(dadaFs, filtFs, dadaRs, filtRs, verbose=TRUE, minOverlap=10, maxMismatch = 1)
# ^less strict merge
head(mergers[[1]])
```
...
```{r}
# save progress
saveRDS(mergers, file = "/Users/iskoec/code/Stool/MS0067_MMAMicro/mouse/mergers1.RDS")
```

```{r}
# read in mergers files
mergers <- readRDS("/Users/iskoec/code/Stool/MS0067_MMAMicro/mouse/mergers1.RDS")
```
...
```{r}
saveRDS(seqtab.nochim, file="/Users/iskoec/code/Stool/MS0067_MMAMicro/mouse/seqtab1.nochim.RDS")
```
```{r}
seqtab.nochim <- readRDS("/Users/iskoec/code/Stool/MS0067_MMAMicro/mouse/seqtab1.nochim.RDS")
```
