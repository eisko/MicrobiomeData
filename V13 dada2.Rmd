...
### START HERE!!!###
```{r}
saveRDS(seqtab.nochim, file="/Users/iskoec/code/Stool/MS0067_MMAMicro/mouse/setab.nochim.RDS")
```
```{r}
seqtab.nochim <- readRDS("/Users/iskoec/code/Stool/MS0067_MMAMicro/mouse/setab.nochim.RDS")
```
...
```{r}
taxa <- assignTaxonomy(seqtab.nochim, "~/code/Stool/silva_nr_v132_train_set.fa.gz", multithread = TRUE)
```
