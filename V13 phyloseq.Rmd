...
```{r}
plot_richness(ps, x = "Experiment", measures=c("Shannon", "Simpson"), color="Experiment.Details")
```
...
ps.phyla <- subset_taxa(ps.rel, Phylum%in%c("Actinobacteria", "Bacteroidetes", "Firmicutes", "Proteobacteria", "Verrucomicrobia", "NA"))
